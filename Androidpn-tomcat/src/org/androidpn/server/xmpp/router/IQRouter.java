...
import org.androidpn.server.xmpp.handler.IQAliasHandler;
import org.androidpn.server.xmpp.handler.IQAuthHandler;
import org.androidpn.server.xmpp.handler.IQConfirmHandler;
...
import org.androidpn.server.xmpp.handler.IQTagsHandler;
...
public class IQRouter {
    ...
    public IQRouter() {
        ...
        iqHandlers.add(new IQConfirmHandler());
        iqHandlers.add(new IQAliasHandler());
        iqHandlers.add(new IQTagsHandler());
