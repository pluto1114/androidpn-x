    ...
    public void process(Packet packet) {
        ...
        try {
            ...
            if (type == null) { // null == available
                ...
                NotificationService notificationService=notificationManager.getNotificationService();
                List<Notification> notifications=notificationService.find(session.getUsername());
